...
export default function PollingStationCard({ name, address, distance_km, score, crowd_factor, avg_wait_minutes, maps_url }: Props) {
  ...
  return (
    <View className="bg-white p-5 rounded-2xl shadow-sm mb-4 border border-slate-100">
      ...
      <View className="flex-row flex-wrap gap-2 mb-4 mt-2">
        <View className={`px-2 py-1 rounded-md ${crowdBadge.split(' ')[0]}`}>
